...
<t:wrapper title="Register">
    <jsp:body>
        <div class="row center-align feed">
            <div class="card-body">
                <h4 class="card-title">Cadastro de Hospedagem</h4>
                <form class="forms-sample" method="post" action="/cadastro/hospedagem">
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Código reserva:</label>
                            <div class="col-sm-9">
                                <select name="reserva" class="form-control">
                                    <c:forEach var="reserva" items="${reservas}">
                                        <option value="${reserva.getId()}">Cliente: ${reserva.getCli().getNome()} Apt: ${reserva.getCli().getNome()} Status: ${reserva.getStatus()}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
