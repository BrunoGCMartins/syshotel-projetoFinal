...
@WebServlet(
        name = "Registration fornecedor",
        urlPatterns = {"/cadastro/fornecedor"}
)
...
//        userRepository = new UserRepository();
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        req.getRequestDispatcher("/cadastro/cadastrofornecedor.jsp").forward(req, resp);
    }
...
*/
        ...
        resp.sendRedirect("/cadastro/fornecedor");
    }
